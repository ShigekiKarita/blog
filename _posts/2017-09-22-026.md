...
標準ライブラリは[謎最適化(unrolling?)](https://github.com/dlang/phobos/blob/master/std/numeric.d#L1716)をしているので速いのだと思います．この結果からすると速くて綺麗な高階関数を使った実装を積極的に使いたいですね．

最後にベンチマークのコードはこちらです [https://github.com/ShigekiKarita/mir-intro](https://github.com/ShigekiKarita/mir-intro)

## 蛇足

最後に，私の mir を使ったプロジェクトを宣伝させてください

+ [numir](https://github.com/ShigekiKarita/numir): numpyライクなAPIで mir-algorithm や mir-random を使いたいというライブラリです．[近々mir入りも考えています](https://github.com/ShigekiKarita/numir/issues/11)
